...
let totalLengthsInCm = 0;
let totalLengthsInInches = 0;

for (let i = 0; i < lengths.length; i += 1) {
  totalLengthsInCm += lengths[i];
  totalLengthsInInches += lengthsInInches[i];
}

let averageLengthInCm = totalLengthsInCm / lengths.length;
let averageLengthInInches = totalLengthsInInches / lengthsInInches.length;

console.log(
  `The average length in cm is ${averageLengthInCm}, which is ${averageLengthInInches} in inches`,
);
